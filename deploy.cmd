...
IF /I "BattcherIntel.sln" NEQ "" (
  call "%NUGET_EXE%" restore "%DEPLOYMENT_SOURCE%\BattcherIntel.sln"
  IF !ERRORLEVEL! NEQ 0 goto error
)
...
IF /I "%IN_PLACE_DEPLOYMENT%" NEQ "1" (
  ...
  %MSBUILD_PATH% "%DEPLOYMENT_SOURCE%\BattcherIntel\BattcherIntel.csproj" /nologo /verbosity:m /t:Build /p:AutoParameterizationWebConfigConnectionStrings=false;Configuration=Release /p:SolutionDir="%DEPLOYMENT_SOURCE%\.\\" %SCM_BUILD_ARGS%
)
